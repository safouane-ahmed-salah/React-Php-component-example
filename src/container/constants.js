export const dashboardBoxes = [
    {name: "Total Incoming", value: "17247", color: "#e77e4e", seconds: '', days: '' , best: '', worst:''},
    {name: "Total Unprocessed", value: "16329", color: "#bd1028", seconds: '', days: '' , best: '', worst:''},
    {name: "Response Time", value: "", color: "#23a4ab", seconds: '0 Seconds', days: '781 days' ,best: 'Best', worst:'Worst'},
];

export const progressCategories = [
    {name: "Unprocessed", value: "16329", color: "#f7a154", statusPercentage: '(95%)', },
